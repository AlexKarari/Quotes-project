...
export class AppComponent {
  addQuotes(Quote: HTMLInputElement, Author: HTMLInputElement, Name: HTMLInputElement): boolean {
    //console.log(`Adding quotes Quote: ${Quote.value}, Author: ${Author.value}and Name: ${Name.value}`);
    this.quotes.push(new Quotes(Quote.value, Author.value, Name.value, 0));
    Quote.value = '';
    Author.value = '';
    Name.value = '';
    return false;
